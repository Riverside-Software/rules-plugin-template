...
public class AcmeDbRulesDefinition implements RulesDefinition {
  public static final String REPOSITORY_KEY = "acme-db-rules";
  public static final String REPOSITORY_NAME = "OpenEdge DB rules (ACME)";

  @SuppressWarnings("rawtypes")
  @Override
  public void define(Context context) {
    NewRepository repository = context.createRepository(REPOSITORY_KEY, Constants.DB_LANGUAGE_KEY).setName(
        REPOSITORY_NAME);
